...
namespace ProjetoSD.WebAPI.Migrations
{
    ...
    [Migration("20181110030124_CreateTableDoenca")]
    partial class CreateTableDoenca
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoSD.WebAPI.Models.Doenca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("Descricao")
                        .IsRequired()
                        .HasColumnName("CDOEDESC")
                        .HasColumnType("VARCHAR(500)");

                    b.Property<string>("Nome")
                        .IsRequired()
                        .HasColumnName("CDOENOME")
                        .HasColumnType("VARCHAR(30)");

                    b.Property<string>("Profilaxia")
                        .IsRequired()
                        .HasColumnName("CDOEPROFLAXIA")
                        .HasColumnType("VARCHAR(500)");
            ...
            modelBuilder.Entity("ProjetoSD.WebAPI.Models.Medico", b =>
                {
                    b.HasOne("ProjetoSD.WebAPI.Models.Usuario", "Usuario")
                        .WithOne("Medico")
                        .HasForeignKey("ProjetoSD.WebAPI.Models.Medico", "UsuarioId")
